...
- AgentBench 已于 2026-07-12 复核 arXiv API、HTTP metadata、摘要和 GitHub README，可支撑“Agent eval 需要交互环境、长期推理、决策、指令遵循和失败原因分析”的保守表述；README 当前已加入 Function Calling 版本和较重的 Docker / 资源需求边界，不能把 leaderboard 或旧环境结果写成当前业务可用性判断。
