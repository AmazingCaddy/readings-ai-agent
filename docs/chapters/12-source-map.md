...
先读手册 09，再看 OWASP LLM Top 10、NIST AI RMF、Microsoft Prompt Shields、Google Responsible AI、OpenAI Agents SDK guardrails / human-in-the-loop / tracing 文档，以及 Semantic Kernel Plugins 文档。
...
- Security / Production：Indirect Prompt Injection paper、OWASP LLM Top 10、NIST AI RMF、Microsoft Prompt Shields、Google Responsible AI、OpenAI Agents SDK、Semantic Kernel。
