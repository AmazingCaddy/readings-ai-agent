...
- SWE-agent / mini-SWE-agent 是否适合作为初学者 repo issue 进阶项目？固定 workflow baseline 和确定性 workflow-agent hybrid baseline 已完成；仍需验证真实模型驱动 hybrid、mini-SWE-agent confirm-mode、sandbox、权限、回滚、测试反馈、成本上限和人工确认负担。
