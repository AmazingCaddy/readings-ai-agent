...
- Eval / Observability：AgentBench、WebArena、τ-bench、OpenAI Evals repo、LangSmith、Phoenix、Browser Use / Playwright、Anthropic Computer Use。
...
- Practice：OpenAI Cookbook、MCP servers repo、OpenAI Evals repo、Browser Use / Playwright、Anthropic Computer Use。
