...
- NIST AI RMF 主页面、AIRC Playbook 和 Critical Infrastructure concept note 已在 2026-07-12 复核，可支撑生产化章节的 voluntary risk management、trustworthiness lifecycle、Govern / Map / Measure / Manage 和高风险场景治理视角；Playbook 不是必须完整照做的 checklist，AI RMF 1.0 与 GenAI profile 的 DOI/PDF 当前均取回失败，NIST 也不是 Agent 专用工程指南。
