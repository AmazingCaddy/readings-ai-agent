...
- 大工具面下，namespace、`tool_search`、allowed tools、strict mode、custom tools / CFG 和 parallel tool-call 设置如何影响真实工具选择准确率、token 成本、延迟和错误恢复？当前只有官方接口边界和本地 control，仍缺真实模型 completed run。
