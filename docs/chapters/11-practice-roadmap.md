...
- Repo Issue Agent 应优先用 SWE-agent、mini-SWE-agent、OpenAI Agents SDK、LangGraph 还是固定 workflow 做最小对比？固定 workflow baseline 和确定性 workflow-agent hybrid baseline 已完成；仍需真实模型驱动 hybrid、mini-SWE-agent confirm 和可选 SWE-agent 运行记录成本、sandbox、回滚、测试反馈和人工确认负担。
