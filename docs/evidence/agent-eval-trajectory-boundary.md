...
- Source 4：[tau2-bench / tau3-bench Current Repository and Documentation](../sources/source-cards/2026-tau2-tau3-bench.md)
- Source 5：[OpenAI Evals Repository](../sources/source-cards/2026-openai-evals-repo.md)
- Source 6：[OpenAI Evaluation Guides](../sources/source-cards/2026-openai-evaluation-guides.md)
- Source 7：[Evidence Note: Browser Agent 与网页自动化边界](browser-agent-boundary.md)
- Source 8：[Trace-Aware Eval 最小实验结果](../experiments/trace-aware-eval/results-2026-07-11.md)
- Source 9：[Grader Misalignment / Reward Hacking 最小实验结果](../experiments/grader-misalignment/results-2026-07-11.md)
