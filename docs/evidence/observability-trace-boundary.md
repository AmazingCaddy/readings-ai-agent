...
- 一致点：OpenAI Graders docs 列出 string check、text similarity、score model grader、Python grader 和 multigrader，并说明 tool-call grading 可以基于 `sample.output_tools` 检查工具名称和参数。
