...
8. 上下文工程与结构化输出边界。窄结论“LLM 应用输入输出不只是字符串”和“schema valid 不等于事实/权限/业务正确”已升级为可入正文；其余上下文治理边界已完成第一轮官方文档交叉验证、标准库输出解析 / 上下文治理模拟实验、上下文策略对比实验和真实 API harness 准备，待实际运行真实 Responses API / Structured Outputs、真实长上下文、RAG / 摘要 / 成本对比和跨模型稳定性实验。
