...
- 一致点：Indirect Prompt Injection paper 的摘要把影响范围连接到 data theft、worming、information ecosystem contamination，以及控制应用功能和 API 调用方式；这与 OWASP 2025 的 prompt injection、improper output handling 和 excessive agency 风险方向一致。
