...
最新记录：见 [2026-07-11 结果](results-2026-07-11.md)。本次运行验证了统一入口、API harness 的 skip 分支、LangGraph `MemorySaver` 最小 run、`SqliteSaver` 本地 SQLite graph 重建恢复 case 和本地 MCP stdio harness；没有完成真实 API 行为验证。
