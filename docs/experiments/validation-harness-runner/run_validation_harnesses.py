...
def compact_payload(payload: dict[str, Any]) -> dict[str, Any]:
    ...
    for key in [
        ...
        "permission_control",
        "permission_control_passed",
        "dangerous_tool_request_count",
        "prompt_only_side_effect_count",
        "policy_enforced_side_effect_count",
        "retrieval",
        "llm_synthesis",
        ...
        "batch_flex_cache_control",
        "batch_flex_cache_control_passed",
        "prompt_cache_fields_seen",
        "flex_fallback_recorded",
        "batch_jsonl_prepared",
        "batch_request_count",
        "batch_custom_id_count",
        "required_batch_fields_present",
        "moderation_control",
