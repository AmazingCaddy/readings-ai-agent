...
检查 source cards、source-card index、章节 references 和本地 Markdown 链接的结构完整性。
...
该 audit 可支撑“手册 references 结构具备本地可追溯性”的窄结论；不能证明外部 URL 当前可访问、资料内容正确、章节解释正确、真实模型 / API / 框架行为、成本、延迟或生产可靠性。
