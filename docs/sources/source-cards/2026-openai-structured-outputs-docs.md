...
- 已完成标准库上下文治理与结构化输出实验：对比自由文本、JSON-mode-like 输出和 schema validation，并记录 schema-valid semantic error。后续仍需真实 Structured Outputs / JSON mode / refusal / semantic validator 实验。
