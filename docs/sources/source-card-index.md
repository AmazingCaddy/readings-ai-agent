...
| [OpenAI Function Calling docs](source-cards/2026-openai-function-calling-docs.md) | Tool Use / Function Calling | Official Docs | A | 关键段落已精读；参数校验/重试模拟实验已完成；真实 API harness 已准备；部分验证 | 实际运行真实模型 / API 实验并补其他框架术语对照 |
...
| [LlamaIndex docs](source-cards/2026-llamaindex-docs.md) | RAG / Data framework | Framework Docs | A | 关键页面已精读；RAG pipeline / citation 模拟实验和上下文策略对比实验已完成；真实 LLM citation harness 已准备；部分验证 | 实际运行 LLM citation harness，并补真实 embedding / LlamaIndex pipeline、metadata filter 和 citation correctness 实验 |
...
| [OpenAI Agents SDK docs](source-cards/2026-openai-agents-sdk-docs.md) | Agent Framework | Official Docs | A | 关键页面已精读；prompt injection / permission 标准库实验和安全 regression set 已完成；部分验证 | 补真实 guardrails/HITL/tool permission 和框架横向对比实验 |
...
| [OpenAI Evals repo](source-cards/2026-openai-evals-repo.md) | Eval / Source Code | Source Code | A | README 和 custom eval 方向已精读；trace-aware eval 实验已完成；真实模型 trace harness 已准备；部分验证 | 实际运行真实 eval harness、LLM-as-judge 误判和人工复核实验 |
...
| [OpenAI Structured Outputs docs](source-cards/2026-openai-structured-outputs-docs.md) | Structured Outputs / JSON Schema | Official Docs | A | Structured Outputs、JSON mode、refusal 和 schema mistakes 边界已精读；标准库上下文/结构化输出实验已完成；真实 API harness 已准备；部分验证 | 实际运行真实 Structured Outputs / JSON mode / refusal / semantic validator 实验 |
...
| [OWASP LLM Top 10](source-cards/2026-owasp-llm-top-10.md) | Security | Security Guidance | A | 关键风险项已精读；prompt injection / permission evidence 已引用；安全 regression set 已完成；真实 API harness 已准备；部分验证 | 实际运行真实攻击样例和框架 guardrail，记录误报/漏报 |
...
| [LangSmith docs](source-cards/2026-langsmith-docs.md) | Observability / Evaluation | Framework Docs | B | 关键页面已精读；trace-aware eval 标准库实验已完成；真实模型 trace harness 已准备；部分验证 | 实际运行真实平台 traces、LLM-as-judge 误判和人工复核实验 |
| [Arize Phoenix docs](source-cards/2026-arize-phoenix-docs.md) | Observability / Evaluation | Framework Docs | B | 关键页面已精读；trace-aware eval 标准库实验已完成；真实模型 trace harness 已准备；部分验证 | 实际运行真实平台 traces/spans/sessions、token/latency 和人工复核实验 |
