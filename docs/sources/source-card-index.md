...
| [LangGraph docs](source-cards/2026-langgraph-docs.md) | Agent 架构 / Orchestration | Framework Docs | A | 关键 stateful workflow / agent / durable execution / HITL 段落已精读；Agent/Workflow 和自治程度窄边界可入正文；真实 LangGraph 行为仍部分验证 | 补真实 LangGraph workflow / agent 对比实验 |
