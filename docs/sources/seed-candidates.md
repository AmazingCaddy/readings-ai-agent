...
| Browser agents | Playwright / browser-use related examples；Anthropic computer use documentation | Source / Engineering | A/B | Browser Use GitHub metadata、README、docs llms.txt、Playwright actions/trace viewer 和 Anthropic computer use official docs 已复核；source cards 已创建；标准库 browser action trace 字段审计已完成；真实浏览器 / computer-use Agent 试跑待做 |
