...
| Prompt injection | Indirect Prompt Injection paper；additional security writeups | Paper / Engineering | A/B | arXiv paper 元数据已复核；source card 已创建；更多工程 writeups 待复核 |
